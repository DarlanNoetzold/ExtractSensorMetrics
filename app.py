...
# Configurações
METRICS_URL = "http://localhost:8080/api/metrics"  # URL do endpoint do controller de métricas
CSV_FILE_PATH = f"metrics_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"  # Nome do arquivo CSV com timestamp
